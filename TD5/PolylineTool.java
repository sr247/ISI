 ...
 *
 */
public class PolylineTool extends CStateMachine {
    ...
    public PolylineTool(final int button, final int modifier) {
	   start = new State() {
	   ...
	   draw = new State() {
			 ...
			 Transition stop = new Release(button, modifier, ">> start") {
				    public void action() {
					   rect.setDiagonal(p1, getPoint()) ;
					   fireEvent(new ShapeCreatedEvent(PolylineTool.this, rect)) ;
				    }
				} ;
		  } ;
    }
